...
Este trabalho apresentará os conceitos relacionados à Central de Serviços (Service Desk) e sua relevância no gerenciamento de operações dos serviços de Tecnologia da Informação (TI).
...
Este tópico abordará o conceito de Central de Serviços no contexto da operação de serviços de TI e sua relevância considerando situações reais da gestão da área de TI em empresas. 

== CONCEITOS

Segundo Melendez Fo (2011), “as instituições e empresas líderes entendem que o investimento adequado em TIC gera retornos em pouco tempo, tanto no que diz respeito a faturamento quanto a soluções para serviços públicos e para o terceiro setor”. Assim, é possível afirmar o grande valor que a área agrega às operações de diversas atividades econômicas.
